...
async def test():
    ...
    # result = await chroma.query("Get information about the system_interactions collection")
    # print(f"Result: {result}")
    
    # await chroma.close()
    
    # traditional connection with chromadb
    chroma_db = ChromaDB()
    print("ChromaDB: ", chroma_db.collection.get())
    results = chroma_db.search_collection("system_interactions", "Get information about the system_interactions collection")
